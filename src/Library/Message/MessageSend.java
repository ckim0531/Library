...
public class MessageSend {
  public static void msgSend(String to, String content) {
    ...
    String messageTo = "01076330531";
    String messageFrom = "01076330531";
    
    params.put("to", to); // 수신번호
    params.put("from", messageFrom); // 발신번호
    params.put("type", "SMS"); // Message type ( SMS, LMS, MMS, ATA )
    params.put("text", content); // 문자내용 // 80자 이내
