...
<%
	...
	bdao.pressBoardUpdateReadcount(num);
...
<div id="container">
	<div>
		...
		<div class="conts">
			<h3>보도자료</h3>
			<p id="nav">
				<img src="../../images/common/icon_home.png" alt="메인"> > 열린마당
				> 보도자료
			</p>
			...
			<div class="ac mt20">
				...
				if (id != null) {
					if (id.equals("admin")) {
				%>
				<a href="pressWrite.jsp" class="btn03 type2 type3">글쓰기</a>
				<a href="pressUpdate.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>"
					class="btn03 type2 type3">수정</a>
				<a href="pressDelete.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>"
					class="btn03 type2 type3">삭제</a>
				<a href="pressReWrite.jsp?num=<%=num%>&
				...
				%>
				<!-- 관리자만 글쓰기 -->
				<a href="pressList.jsp" class="btn03 type2 type3">목록</a>
			</div>
		</div>
	</div>
</div>
