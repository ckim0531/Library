...
<%
	...
	if (count != 0) {
		...
		boardList = ndao.bookBoardGetRecommendList(startRow, pageSize);
	}
%>
		...
		<div id="left">
			...
			<div class="page">
				<ul>
					...
					%>
 								<%-- <a href="bookRecommend.jsp?pageNum=<%=startPage - pageBlock%>">
					...
					%>
									<li class="on">
										<a href="bookRecommend.jsp?pageNum=<%=i%>"><%=i%>
									</a>
					<%
								} else {
					%>
									<li>
										<a href="bookRecommend.jsp?pageNum=<%=i%>"><%=i%></a>
									</li>
					<%
								}
							}
